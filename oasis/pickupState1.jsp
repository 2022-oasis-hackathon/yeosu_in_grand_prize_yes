...
<body>
	<form action="transit?idx=<c:out value="${param.idx}"/>&status=배달중" method="post" enctype="multipart/form-data">
		...
		<div class="pickup_wrap">
			...
			<div class="pickup_text">
				<b>픽업하는 사진</b>을 찍어주세요!<br> <span>예) 배달 물품을 손으로 들고 있는 사진</span>
			</div>
		</div>
